...
export const aeratorSets: Product[] = [
  ...
  {
    id: 'aqualion-hv20b',
    slug: 'aqualion-2hp-4-paddle-hv20b',
    name: 'AQUA LION 2HP 4 Paddle Wheel Aerator Set (HV 20 B)',
    model: 'HV 20 B',
    brand: 'aqualion',
    category: 'aerator-set',
    mrp: 30000,
    ...
    features: [
      'Aqualion 2HP Heavy Duty Motor (ISO Certified)',
      'A3 Bevel Gearbox (105 RPM)',
      'SS 202 Frame (2mm Thickness)',
      'Virgin HDPE Floats (7kg)',
      '1 Year Warranty'
    ],
    components: [
      ...
      { item: 'STARTER', spec: 'no', quantity: 0 },
      { item: 'WIRE', spec: 'no', quantity: 0 },
      { item: 'GEAR OIL', spec: 'no', quantity: 0 },
  ...
  // Sea Boss Budget + Performance Sets
  {
    ...
    components: [
      ...
      { item: 'FLOAT', spec: '6.5 KG  APX - Virgin HDPE (UV)', quantity: 3 },
  ...
  },
  {
    ...
    components: [
      ...
      { item: 'STARTER', spec: 'no', quantity: 0 },
      { item: 'WIRE', spec: 'no', quantity: 0 },
      { item: 'GEAR OIL', spec: 'Yes', quantity: 2 },
      { item: 'WARRANTY', spec: '1 year warranty', quantity: '' },
    ],
    specifications: {
      'Product Name': 'SEA BOSS 2HP 4 PADDLE WHEEL AERATOR SET',
