                ...
                <div className="overflow-x-auto no-scrollbar -mx-4 px-4 md:mx-0 md:px-0">
                    <div className="flex items-center gap-3 min-w-max">
                        <button
                            ...
                            className={`relative px-5 py-2 rounded-full text-sm font-semibold transition-colors duration-200 ${selectedBrand === 'all'
                                ? 'text-white'
                        ...
                        <button
                            ...
                            className={`relative px-5 py-2 rounded-full text-sm font-semibold transition-colors duration-200 ${selectedBrand === 'aqualion'
                                ? 'text-white'
                                : 'text-black bg-steel-200 hover:bg-steel-300'
                                }`}
                        >
                            {selectedBrand === 'aqualion' && (
                                <motion.div
                                    layoutId="activeBrand"
                                    className="absolute inset-0 bg-gradient-to-r from-amber-400 to-amber-500 rounded-full shadow-lg shadow-amber-500/30"
                                    initial={false}
                                    transition={{ type: "spring", stiffness: 500, damping: 35, mass: 0.8 }}
                                />
                            )}
                        ...
                        <button
                            ...
                            className={`relative px-5 py-2 rounded-full text-sm font-semibold transition-colors duration-200 ${selectedBrand === 'seaboss'
                                ? 'text-white'
                                : 'text-black bg-steel-200 hover:bg-steel-300'
                                }`}
                        >
                            {selectedBrand === 'seaboss' && (
                                <motion.div
                                    layoutId="activeBrand"
                                    className="absolute inset-0 bg-gradient-to-r from-blue-400 to-blue-500 rounded-full shadow-lg shadow-blue-500/30"
                                    initial={false}
                                    transition={{ type: "spring", stiffness: 500, damping: 35, mass: 0.8 }}
                                />
                            )}
